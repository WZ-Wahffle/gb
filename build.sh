...
function build() {
	...
	gcc -O3 -o out/gbc src/*.c src/carts/*.c src/ui.o -Isrc/include/ -Lsrc/lib/ -l:libraylib.a -l:libSDL2.a -lm -lrlImGui -limgui -Wall -Wextra -Werror -lstdc++ -Wno-unused-function
}
